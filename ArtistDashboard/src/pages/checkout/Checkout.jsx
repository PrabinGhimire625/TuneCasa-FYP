...
{checkoutDone && (
  ...
  >
    Download Details
      ...
      {/* Songs Breakdown (if you have individual song earnings) */}
      ...
      <div className="bg-gray-800 p-6 rounded-2xl shadow-md mb-6 flex items-start space-x-4">
        ...
        <div>
          ...
          <ul className="list-disc pl-4 text-sm text-gray-300 space-y-1">
            <li>Minimum earning required for checkout is NPR 1000.</li>
            <li>Checkout requests are processed within 3–5 business days.</li>
            <li>Please make sure your payment details are up-to-date.</li>
            <li>You will receive a notification once the transaction is initiated.</li>
          </ul>
        </div>
      </div>
  ...
  <div className="flex items-center justify-center mt-8">
    <div className="bg-red-600 px-6 py-3 rounded-full text-white flex items-center gap-2 font-semibold shadow-lg">
      ...
      You do not have enough earnings to checkout
    </div>
  </div>
)}
